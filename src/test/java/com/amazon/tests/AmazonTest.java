...
public final class AmazonTest extends BaseTest {
	...
	public void test1(AmazonTestData data) {
		AmazonProductPage productPage = new AmazonHomePage()
				.clickHamburgerMenu()
				.clickCategory(data.getCategory())
				.clickSubCategory(data.getSubcategory())
				.filterCategoryResults(data.getFiltersection(), data.getFiltervalue())
				.sortResults(data.getSorttype())
				.selectSecondItem();
